...
import { Flex, Text, Skeleton } from '@neptuneswap/neptuneswapuikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, ethereum, account }) => {
  ...
  const totalValue: BigNumber = useMemo(() => {
    ...
    if (farm.quoteTokenSymbol === QuoteToken.TUNE) {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'TUNE'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'TUNE' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
