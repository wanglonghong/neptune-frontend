...
import { getNeptuneProfileAddress, getNeptuneRabbitsAddress } from 'utils/addressHelpers'
import tuneProfileAbi from 'config/abi/tuneProfile.json'
...
const profileContract = getContract(tuneProfileAbi, getNeptuneProfileAddress())
const rabbitContract = getContract(tuneRabbitsAbi, getNeptuneRabbitsAddress())
