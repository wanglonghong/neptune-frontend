...
import tuneRabbits from 'config/abi/tuneRabbits.json'
import lottery from 'config/abi/lottery.json'
import lotteryTicket from 'config/abi/lotteryNft.json'
import masterChef from 'config/abi/masterchef.json'
import sousChef from 'config/abi/sousChef.json'
import sousChefBnb from 'config/abi/sousChefBnb.json'
import profile from 'config/abi/tuneProfile.json'
...
export const useCake = () => {
  return useERC20(getNeptuneAddress())
}
...
export const useTuneRabbits = () => {
  const tuneRabbitsAbi = (tuneRabbits as unknown) as AbiItem
  return useContract(tuneRabbitsAbi, getNeptuneRabbitsAddress())
}

export const useProfile = () => {
  const profileABIAbi = (profile as unknown) as AbiItem
  return useContract(profileABIAbi, getNeptuneProfileAddress())
}
